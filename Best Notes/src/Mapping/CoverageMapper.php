...
class CoverageMapper implements MapperInterface{
    ...
    public function __construct()
    {
        ...
        $mappingPath = __DIR__ . '/../../coverage_mapping.json';
        $json = file_get_contents($mappingPath);
        $this->mapping = json_decode($json, true);
    }

    /**
     * Map a FHIR Coverage resource to XML using a field mapping configuration.
     */
    public function map(array $fhir, DOMDocument $doc): DOMElement{
        // Create the <Coverage> root element
